...
All the third party tools installed using conda are available at $HOME/RNASeqPIPE/ [default location]
or the user specified location during the installation process.

The script to run bulk RNASeq Pipeline (RNASeqPIPE.py) is available inside the bulkRNASeqPIPE folder, 
that you cloned from github. bulkRNASeqPIPE folder will be your working directory.
...
Change directory to bulkRNASeqPIPE
